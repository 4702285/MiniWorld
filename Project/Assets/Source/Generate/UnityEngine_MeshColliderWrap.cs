...
public class UnityEngine_MeshColliderWrap
{
	...
	{
		UnityEngine.MeshCollider obj = null;
		try
		{
			obj = (UnityEngine.MeshCollider)ToLua.ToObject(L, 1);
	...
	static int set_cookingOptions(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.MeshCollider)ToLua.ToObject(L, 1);
			UnityEngine.MeshColliderCookingOptions arg0 = StackTraits<UnityEngine.MeshColliderCookingOptions>.Check(L, 2);
