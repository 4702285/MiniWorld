...
public class UnityEngine_PhysicsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("autoSimulation", new LuaCSFunction(get_autoSimulation), new LuaCSFunction(set_autoSimulation));
	...
	static int IgnoreCollision(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				UnityEngine.Collider arg0 = ToLua.CheckObject<UnityEngine.Collider>(L, 1);
				UnityEngine.Collider arg1 = ToLua.CheckObject<UnityEngine.Collider>(L, 2);
	...
	static int Raycast(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Ray, float, int, UnityEngine.QueryTriggerInteraction>(L, 1))
			{
				...
				float arg1 = (float)LuaDLL.lua_tonumber(L, 2);
				int arg2 = (int)LuaDLL.lua_tointeger(L, 3);
				UnityEngine.QueryTriggerInteraction arg3 = StackTraits<UnityEngine.QueryTriggerInteraction>.To(L, 4);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Vector3, UnityEngine.Vector3, float, int, UnityEngine.QueryTriggerInteraction>(L, 1))
			{
				...
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
				int arg3 = (int)LuaDLL.lua_tointeger(L, 4);
				UnityEngine.QueryTriggerInteraction arg4 = StackTraits<UnityEngine.QueryTriggerInteraction>.To(L, 5);
			...
			else if (count == 6)
			{
				...
				UnityEngine.QueryTriggerInteraction arg5 = StackTraits<UnityEngine.QueryTriggerInteraction>.Check(L, 6);
	...
	static int Linecast(IntPtr L)
	{
		try
		{
			...
			else if (count == 5)
			{
				...
				UnityEngine.QueryTriggerInteraction arg4 = StackTraits<UnityEngine.QueryTriggerInteraction>.Check(L, 5);
	...
	static int CapsuleCast(IntPtr L)
	{
		try
		{
			...
			else if (count == 7 && TypeChecker.CheckTypes<float, int, UnityEngine.QueryTriggerInteraction>(L, 5))
			{
				...
				float arg4 = (float)LuaDLL.lua_tonumber(L, 5);
				int arg5 = (int)LuaDLL.lua_tointeger(L, 6);
				UnityEngine.QueryTriggerInteraction arg6 = StackTraits<UnityEngine.QueryTriggerInteraction>.To(L, 7);
			...
			else if (count == 8)
			{
				...
				UnityEngine.QueryTriggerInteraction arg7 = StackTraits<UnityEngine.QueryTriggerInteraction>.Check(L, 8);
	...
	static int SphereCast(IntPtr L)
	{
		try
		{
			...
			else if (count == 6 && TypeChecker.CheckTypes<UnityEngine.Ray, float, LuaInterface.LuaOut<UnityEngine.RaycastHit>, float, int, UnityEngine.QueryTriggerInteraction>(L, 1))
			{
				...
				float arg3 = (float)LuaDLL.lua_tonumber(L, 4);
				int arg4 = (int)LuaDLL.lua_tointeger(L, 5);
				UnityEngine.QueryTriggerInteraction arg5 = StackTraits<UnityEngine.QueryTriggerInteraction>.To(L, 6);
			...
			else if (count == 7)
			{
				...
				UnityEngine.QueryTriggerInteraction arg6 = StackTraits<UnityEngine.QueryTriggerInteraction>.Check(L, 7);
	...
	static int OverlapSphere(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 2);
				int arg2 = (int)LuaDLL.luaL_checkinteger(L, 3);
				UnityEngine.QueryTriggerInteraction arg3 = StackTraits<UnityEngine.QueryTriggerInteraction>.Check(L, 4);
	...
	static int ComputePenetration(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Collider arg3 = ToLua.CheckObject<UnityEngine.Collider>(L, 4);
