...
public class UnityEngine_AsyncOperationWrap
{
	...
	{
		UnityEngine.AsyncOperation obj = null;
		try
		{
			obj = (UnityEngine.AsyncOperation)ToLua.ToObject(L, 1);
			bool ret = obj.isDone;
	...
	static int set_completed(IntPtr L)
	{
		try
		{
			UnityEngine.AsyncOperation obj = ToLua.CheckObject<UnityEngine.AsyncOperation>(L, 1);
