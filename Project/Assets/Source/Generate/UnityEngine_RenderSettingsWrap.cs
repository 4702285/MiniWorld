...
public class UnityEngine_RenderSettingsWrap
{
	...
	static int get_fogMode(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.RenderSettings.fogMode);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_ambientMode(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.RenderSettings.ambientMode);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_defaultReflectionMode(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.RenderSettings.defaultReflectionMode);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_fogMode(IntPtr L)
	{
		try
		{
			UnityEngine.FogMode arg0 = StackTraits<UnityEngine.FogMode>.Check(L, 2);
	...
	static int set_ambientMode(IntPtr L)
	{
		try
		{
			UnityEngine.Rendering.AmbientMode arg0 = StackTraits<UnityEngine.Rendering.AmbientMode>.Check(L, 2);
	...
	static int set_sun(IntPtr L)
	{
		try
		{
			UnityEngine.Light arg0 = ToLua.CheckObject<UnityEngine.Light>(L, 2);
	...
	static int set_customReflection(IntPtr L)
	{
		try
		{
			UnityEngine.Cubemap arg0 = ToLua.CheckObject<UnityEngine.Cubemap>(L, 2);
	...
	static int set_defaultReflectionMode(IntPtr L)
	{
		try
		{
			UnityEngine.Rendering.DefaultReflectionMode arg0 = StackTraits<UnityEngine.Rendering.DefaultReflectionMode>.Check(L, 2);
