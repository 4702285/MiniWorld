...
public class UnityEngine_Texture2DWrap
{
	...
	static int _CreateUnityEngine_Texture2D(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.TextureFormat, bool>(L, 3))
			{
				int arg0 = (int)LuaDLL.luaL_checkinteger(L, 1);
				int arg1 = (int)LuaDLL.luaL_checkinteger(L, 2);
				UnityEngine.TextureFormat arg2 = StackTraits<UnityEngine.TextureFormat>.To(L, 3);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Experimental.Rendering.DefaultFormat, UnityEngine.Experimental.Rendering.TextureCreationFlags>(L, 3))
			{
				int arg0 = (int)LuaDLL.luaL_checkinteger(L, 1);
				int arg1 = (int)LuaDLL.luaL_checkinteger(L, 2);
				UnityEngine.Experimental.Rendering.DefaultFormat arg2 = StackTraits<UnityEngine.Experimental.Rendering.DefaultFormat>.To(L, 3);
				UnityEngine.Experimental.Rendering.TextureCreationFlags arg3 = StackTraits<UnityEngine.Experimental.Rendering.TextureCreationFlags>.To(L, 4);
				UnityEngine.Texture2D obj = new UnityEngine.Texture2D(arg0, arg1, arg2, arg3);
				ToLua.PushSealed(L, obj);
				return 1;
			}
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Experimental.Rendering.GraphicsFormat, UnityEngine.Experimental.Rendering.TextureCreationFlags>(L, 3))
			{
				int arg0 = (int)LuaDLL.luaL_checkinteger(L, 1);
				int arg1 = (int)LuaDLL.luaL_checkinteger(L, 2);
				UnityEngine.Experimental.Rendering.GraphicsFormat arg2 = StackTraits<UnityEngine.Experimental.Rendering.GraphicsFormat>.To(L, 3);
				UnityEngine.Experimental.Rendering.TextureCreationFlags arg3 = StackTraits<UnityEngine.Experimental.Rendering.TextureCreationFlags>.To(L, 4);
				UnityEngine.Texture2D obj = new UnityEngine.Texture2D(arg0, arg1, arg2, arg3);
				ToLua.PushSealed(L, obj);
				return 1;
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Experimental.Rendering.GraphicsFormat, int, UnityEngine.Experimental.Rendering.TextureCreationFlags>(L, 3))
			{
				...
				UnityEngine.Experimental.Rendering.GraphicsFormat arg2 = StackTraits<UnityEngine.Experimental.Rendering.GraphicsFormat>.To(L, 3);
				int arg3 = (int)LuaDLL.lua_tointeger(L, 4);
				UnityEngine.Experimental.Rendering.TextureCreationFlags arg4 = StackTraits<UnityEngine.Experimental.Rendering.TextureCreationFlags>.To(L, 5);
				UnityEngine.Texture2D obj = new UnityEngine.Texture2D(arg0, arg1, arg2, arg3, arg4);
				ToLua.PushSealed(L, obj);
				return 1;
			}
	...
	static int Compress(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Texture2D obj = ToLua.CheckObject<UnityEngine.Texture2D>(L, 1);
	...
	static int CreateExternalTexture(IntPtr L)
	{
		try
		{
			...
			int arg0 = (int)LuaDLL.luaL_checkinteger(L, 1);
			int arg1 = (int)LuaDLL.luaL_checkinteger(L, 2);
			UnityEngine.TextureFormat arg2 = StackTraits<UnityEngine.TextureFormat>.Check(L, 3);
	...
	static int Resize(IntPtr L)
	{
		try
		{
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.TextureFormat, bool>(L, 4))
			{
				...
				int arg0 = (int)LuaDLL.luaL_checkinteger(L, 2);
				int arg1 = (int)LuaDLL.luaL_checkinteger(L, 3);
				UnityEngine.TextureFormat arg2 = StackTraits<UnityEngine.TextureFormat>.To(L, 4);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Experimental.Rendering.GraphicsFormat, bool>(L, 4))
			{
				...
				int arg0 = (int)LuaDLL.luaL_checkinteger(L, 2);
				int arg1 = (int)LuaDLL.luaL_checkinteger(L, 3);
				UnityEngine.Experimental.Rendering.GraphicsFormat arg2 = StackTraits<UnityEngine.Experimental.Rendering.GraphicsFormat>.To(L, 4);
				bool arg3 = LuaDLL.lua_toboolean(L, 5);
				bool o = obj.Resize(arg0, arg1, arg2, arg3);
				LuaDLL.lua_pushboolean(L, o);
				return 1;
	...
	{
		UnityEngine.Texture2D obj = null;
		try
		{
			obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
	...
	static int get_vtOnly(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index vtOnly on a nil value");
		}
	}
	...
	static int get_minimumMipmapLevel(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index minimumMipmapLevel on a nil value");
		}
	}
	...
	static int get_calculatedMipmapLevel(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index calculatedMipmapLevel on a nil value");
		}
	}
