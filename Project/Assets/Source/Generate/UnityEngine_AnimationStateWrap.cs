...
public class UnityEngine_AnimationStateWrap
{
	...
	static int AddMixingTransform(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				UnityEngine.AnimationState obj = ToLua.CheckObject<UnityEngine.AnimationState>(L, 1);
	...
	{
		UnityEngine.AnimationState obj = null;
		try
		{
			obj = (UnityEngine.AnimationState)ToLua.ToObject(L, 1);
	...
	static int set_blendMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.AnimationState)ToLua.ToObject(L, 1);
			UnityEngine.AnimationBlendMode arg0 = StackTraits<UnityEngine.AnimationBlendMode>.Check(L, 2);
			obj.blendMode = arg0;
			return 0;
		}
		catch(Exception e)
