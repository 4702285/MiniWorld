...
public class UnityEngine_CameraWrap
{
	...
	static int Reset(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Camera obj = ToLua.CheckObject<UnityEngine.Camera>(L, 1);
			obj.Reset();
			return 0;
		}
		catch (Exception e)
	...
	static int SetReplacementShader(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Camera obj = ToLua.CheckObject<UnityEngine.Camera>(L, 1);
			UnityEngine.Shader arg0 = ToLua.CheckObject<UnityEngine.Shader>(L, 2);
	...
	static int CalculateFrustumCorners(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Camera.MonoOrStereoscopicEye arg2 = StackTraits<UnityEngine.Camera.MonoOrStereoscopicEye>.Check(L, 4);
	...
	static int GetStereoNonJitteredProjectionMatrix(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Camera obj = ToLua.CheckObject<UnityEngine.Camera>(L, 1);
			UnityEngine.Camera.StereoscopicEye arg0 = StackTraits<UnityEngine.Camera.StereoscopicEye>.Check(L, 2);
	...
	static int SetupCurrent(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Camera arg0 = ToLua.CheckObject<UnityEngine.Camera>(L, 1);
	...
	static int CopyFrom(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Camera obj = ToLua.CheckObject<UnityEngine.Camera>(L, 1);
			UnityEngine.Camera arg0 = ToLua.CheckObject<UnityEngine.Camera>(L, 2);
			obj.CopyFrom(arg0);
			return 0;
		}
		catch (Exception e)
	...
	static int RemoveCommandBuffers(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Camera obj = ToLua.CheckObject<UnityEngine.Camera>(L, 1);
			UnityEngine.Rendering.CameraEvent arg0 = StackTraits<UnityEngine.Rendering.CameraEvent>.Check(L, 2);
	...
	{
		UnityEngine.Camera obj = null;
		try
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
	...
	static int get_overrideSceneCullingMask(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index overrideSceneCullingMask on a nil value");
		}
	}
	...
	static int set_renderingPath(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			UnityEngine.RenderingPath arg0 = StackTraits<UnityEngine.RenderingPath>.Check(L, 2);
	...
	static int set_opaqueSortMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			UnityEngine.Rendering.OpaqueSortMode arg0 = StackTraits<UnityEngine.Rendering.OpaqueSortMode>.Check(L, 2);
	...
	static int set_transparencySortMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			UnityEngine.TransparencySortMode arg0 = StackTraits<UnityEngine.TransparencySortMode>.Check(L, 2);
	...
	static int set_cameraType(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			UnityEngine.CameraType arg0 = StackTraits<UnityEngine.CameraType>.Check(L, 2);
			obj.cameraType = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_clearFlags(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			UnityEngine.CameraClearFlags arg0 = StackTraits<UnityEngine.CameraClearFlags>.Check(L, 2);
			obj.clearFlags = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_depthTextureMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			UnityEngine.DepthTextureMode arg0 = StackTraits<UnityEngine.DepthTextureMode>.Check(L, 2);
	...
	static int set_gateFit(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			UnityEngine.Camera.GateFitMode arg0 = StackTraits<UnityEngine.Camera.GateFitMode>.Check(L, 2);
			obj.gateFit = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_stereoTargetEye(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			UnityEngine.StereoTargetEyeMask arg0 = StackTraits<UnityEngine.StereoTargetEyeMask>.Check(L, 2);
