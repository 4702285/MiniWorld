...
public class UnityEngine_RigidbodyWrap
{
	...
	static int SetDensity(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Rigidbody obj = ToLua.CheckObject<UnityEngine.Rigidbody>(L, 1);
	...
	static int AddForce(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				UnityEngine.Rigidbody obj = ToLua.CheckObject<UnityEngine.Rigidbody>(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.ForceMode arg1 = StackTraits<UnityEngine.ForceMode>.Check(L, 3);
			...
			else if (count == 5)
			{
				...
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 4);
				UnityEngine.ForceMode arg3 = StackTraits<UnityEngine.ForceMode>.Check(L, 5);
	...
	static int AddForceAtPosition(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
				UnityEngine.ForceMode arg2 = StackTraits<UnityEngine.ForceMode>.Check(L, 4);
	...
	static int AddExplosionForce(IntPtr L)
	{
		try
		{
			...
			else if (count == 6)
			{
				...
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 4);
				float arg3 = (float)LuaDLL.luaL_checknumber(L, 5);
				UnityEngine.ForceMode arg4 = StackTraits<UnityEngine.ForceMode>.Check(L, 6);
	...
	static int SweepTest(IntPtr L)
	{
		try
		{
			...
			else if (count == 5)
			{
				...
				UnityEngine.RaycastHit arg1;
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 4);
				UnityEngine.QueryTriggerInteraction arg3 = StackTraits<UnityEngine.QueryTriggerInteraction>.Check(L, 5);
	...
	static int SweepTestAll(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				UnityEngine.QueryTriggerInteraction arg2 = StackTraits<UnityEngine.QueryTriggerInteraction>.Check(L, 4);
	...
	{
		UnityEngine.Rigidbody obj = null;
		try
		{
			obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
	...
	static int set_constraints(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
			UnityEngine.RigidbodyConstraints arg0 = StackTraits<UnityEngine.RigidbodyConstraints>.Check(L, 2);
	...
	static int set_collisionDetectionMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
			UnityEngine.CollisionDetectionMode arg0 = StackTraits<UnityEngine.CollisionDetectionMode>.Check(L, 2);
	...
	static int set_interpolation(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
			UnityEngine.RigidbodyInterpolation arg0 = StackTraits<UnityEngine.RigidbodyInterpolation>.Check(L, 2);
