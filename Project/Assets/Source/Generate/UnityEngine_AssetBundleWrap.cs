...
public class UnityEngine_AssetBundleWrap
{
	...
	static int LoadFromStreamAsync(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				System.IO.Stream arg0 = ToLua.CheckObject<System.IO.Stream>(L, 1);
	...
	static int Contains(IntPtr L)
	{
		try
		{
			...
			UnityEngine.AssetBundle obj = ToLua.CheckObject<UnityEngine.AssetBundle>(L, 1);
	...
	static int RecompressAssetBundleAsync(IntPtr L)
	{
		try
		{
			...
			else if (count == 5)
			{
				...
				UnityEngine.BuildCompression arg2 = StackTraits<UnityEngine.BuildCompression>.Check(L, 3);
				uint arg3 = (uint)LuaDLL.luaL_checkinteger(L, 4);
				UnityEngine.ThreadPriority arg4 = StackTraits<UnityEngine.ThreadPriority>.Check(L, 5);
	...
	static int get_isStreamedSceneAssetBundle(IntPtr L)
	{
		...
		try
		{
			obj = (UnityEngine.AssetBundle)ToLua.ToObject(L, 1);
