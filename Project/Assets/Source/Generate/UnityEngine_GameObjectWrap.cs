...
public class UnityEngine_GameObjectWrap
{
	...
	static int CreatePrimitive(IntPtr L)
	{
		try
		{
			...
			UnityEngine.PrimitiveType arg0 = StackTraits<UnityEngine.PrimitiveType>.Check(L, 1);
	...
	static int GetComponent(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.GameObject obj = ToLua.CheckObject<UnityEngine.GameObject>(L, 1);
	...
	static int get_transform(IntPtr L)
	{
		...
		try
		{
			obj = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
