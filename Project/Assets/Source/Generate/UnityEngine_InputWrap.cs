...
public class UnityEngine_InputWrap
{
	...
	static int GetKey(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.KeyCode arg0 = StackTraits<UnityEngine.KeyCode>.To(L, 1);
	...
	static int get_imeCompositionMode(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Input.imeCompositionMode);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_deviceOrientation(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Input.deviceOrientation);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_imeCompositionMode(IntPtr L)
	{
		try
		{
			UnityEngine.IMECompositionMode arg0 = StackTraits<UnityEngine.IMECompositionMode>.Check(L, 2);
