...
public class UnityEngine_CharacterControllerWrap
{
	...
	static int SimpleMove(IntPtr L)
	{
		try
		{
			...
			UnityEngine.CharacterController obj = ToLua.CheckObject<UnityEngine.CharacterController>(L, 1);
	...
	{
		UnityEngine.CharacterController obj = null;
		try
		{
			obj = (UnityEngine.CharacterController)ToLua.ToObject(L, 1);
