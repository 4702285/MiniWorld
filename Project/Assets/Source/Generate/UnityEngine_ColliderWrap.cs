...
public class UnityEngine_ColliderWrap
{
	...
	static int ClosestPoint(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Collider obj = ToLua.CheckObject<UnityEngine.Collider>(L, 1);
	...
	{
		UnityEngine.Collider obj = null;
		try
		{
			obj = (UnityEngine.Collider)ToLua.ToObject(L, 1);
	...
	static int get_attachedArticulationBody(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index attachedArticulationBody on a nil value");
		}
	}
	...
	static int set_sharedMaterial(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Collider)ToLua.ToObject(L, 1);
			UnityEngine.PhysicMaterial arg0 = ToLua.CheckObject<UnityEngine.PhysicMaterial>(L, 2);
