...
public class UnityEngine_MaterialWrap
{
	...
	static int HasProperty(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.Material obj = ToLua.CheckObject<UnityEngine.Material>(L, 1);
	...
	static int Lerp(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Material arg1 = ToLua.CheckObject<UnityEngine.Material>(L, 3);
	...
	static int SetTexture(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes<int, UnityEngine.RenderTexture, UnityEngine.Rendering.RenderTextureSubElement>(L, 2))
			{
				...
				UnityEngine.Rendering.RenderTextureSubElement arg2 = StackTraits<UnityEngine.Rendering.RenderTextureSubElement>.To(L, 4);
	...
	{
		UnityEngine.Material obj = null;
		try
		{
			obj = (UnityEngine.Material)ToLua.ToObject(L, 1);
	...
	static int set_globalIlluminationFlags(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Material)ToLua.ToObject(L, 1);
			UnityEngine.MaterialGlobalIlluminationFlags arg0 = StackTraits<UnityEngine.MaterialGlobalIlluminationFlags>.Check(L, 2);
