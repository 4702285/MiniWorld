...
public class UnityEngine_ComponentWrap
{
	...
	static int GetComponent(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.Component obj = ToLua.CheckObject<UnityEngine.Component>(L, 1);
	...
	static int SendMessageUpwards(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.SendMessageOptions>(L, 3))
			{
				UnityEngine.Component obj = ToLua.CheckObject<UnityEngine.Component>(L, 1);
				string arg0 = ToLua.CheckString(L, 2);
				UnityEngine.SendMessageOptions arg1 = StackTraits<UnityEngine.SendMessageOptions>.To(L, 3);
			...
			else if (count == 4)
			{
				...
				string arg0 = ToLua.CheckString(L, 2);
				object arg1 = ToLua.ToVarObject(L, 3);
				UnityEngine.SendMessageOptions arg2 = StackTraits<UnityEngine.SendMessageOptions>.Check(L, 4);
	...
	{
		UnityEngine.Component obj = null;
		try
		{
			obj = (UnityEngine.Component)ToLua.ToObject(L, 1);
