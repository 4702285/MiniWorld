...
public class UnityEngine_AnimatorWrap
{
	...
	static int GetFloat(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.Animator obj = ToLua.CheckObject<UnityEngine.Animator>(L, 1);
	...
	static int GetIKPosition(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Animator obj = ToLua.CheckObject<UnityEngine.Animator>(L, 1);
			UnityEngine.AvatarIKGoal arg0 = StackTraits<UnityEngine.AvatarIKGoal>.Check(L, 2);
	...
	static int GetIKHintPosition(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Animator obj = ToLua.CheckObject<UnityEngine.Animator>(L, 1);
			UnityEngine.AvatarIKHint arg0 = StackTraits<UnityEngine.AvatarIKHint>.Check(L, 2);
	...
	static int SetBoneLocalRotation(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 3);
			UnityEngine.Animator obj = ToLua.CheckObject<UnityEngine.Animator>(L, 1);
			UnityEngine.HumanBodyBones arg0 = StackTraits<UnityEngine.HumanBodyBones>.Check(L, 2);
			UnityEngine.Quaternion arg1 = ToLua.ToQuaternion(L, 3);
	...
	static int MatchTarget(IntPtr L)
	{
		try
		{
			...
			if (count == 6)
			{
				...
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Quaternion arg1 = ToLua.ToQuaternion(L, 3);
				UnityEngine.AvatarTarget arg2 = StackTraits<UnityEngine.AvatarTarget>.Check(L, 4);
	...
	static int SetTarget(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 3);
			UnityEngine.Animator obj = ToLua.CheckObject<UnityEngine.Animator>(L, 1);
			UnityEngine.AvatarTarget arg0 = StackTraits<UnityEngine.AvatarTarget>.Check(L, 2);
			float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
	...
	{
		UnityEngine.Animator obj = null;
		try
		{
			obj = (UnityEngine.Animator)ToLua.ToObject(L, 1);
	...
	static int set_updateMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Animator)ToLua.ToObject(L, 1);
			UnityEngine.AnimatorUpdateMode arg0 = StackTraits<UnityEngine.AnimatorUpdateMode>.Check(L, 2);
			obj.updateMode = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_cullingMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Animator)ToLua.ToObject(L, 1);
			UnityEngine.AnimatorCullingMode arg0 = StackTraits<UnityEngine.AnimatorCullingMode>.Check(L, 2);
	...
	static int set_runtimeAnimatorController(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Animator)ToLua.ToObject(L, 1);
			UnityEngine.RuntimeAnimatorController arg0 = ToLua.CheckObject<UnityEngine.RuntimeAnimatorController>(L, 2);
	...
	static int set_avatar(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Animator)ToLua.ToObject(L, 1);
			UnityEngine.Avatar arg0 = ToLua.CheckObject<UnityEngine.Avatar>(L, 2);
			obj.avatar = arg0;
			return 0;
		}
		catch(Exception e)
