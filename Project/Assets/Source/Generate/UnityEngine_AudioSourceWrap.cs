...
public class UnityEngine_AudioSourceWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("PlayOnGamepad", new LuaCSFunction(PlayOnGamepad));
		L.RegFunction("DisableGamepadOutput", new LuaCSFunction(DisableGamepadOutput));
		L.RegFunction("SetGamepadSpeakerMixLevel", new LuaCSFunction(SetGamepadSpeakerMixLevel));
		L.RegFunction("SetGamepadSpeakerMixLevelDefault", new LuaCSFunction(SetGamepadSpeakerMixLevelDefault));
		L.RegFunction("SetGamepadSpeakerRestrictedAudio", new LuaCSFunction(SetGamepadSpeakerRestrictedAudio));
		L.RegFunction("GamepadSpeakerSupportsOutputType", new LuaCSFunction(GamepadSpeakerSupportsOutputType));
		...
		L.RegVar("gamepadSpeakerOutputType", new LuaCSFunction(get_gamepadSpeakerOutputType), new LuaCSFunction(set_gamepadSpeakerOutputType));
	...
	static int PlayOnGamepad(IntPtr L)
	{
		try
		{
			...
			UnityEngine.AudioSource obj = ToLua.CheckObject<UnityEngine.AudioSource>(L, 1);
	...
	static int GamepadSpeakerSupportsOutputType(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.GamepadSpeakerOutputType arg0 = StackTraits<UnityEngine.GamepadSpeakerOutputType>.Check(L, 1);
	...
	static int PlayOneShot(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.AudioSource obj = ToLua.CheckObject<UnityEngine.AudioSource>(L, 1);
				UnityEngine.AudioClip arg0 = ToLua.CheckObject<UnityEngine.AudioClip>(L, 2);
	...
	static int PlayClipAtPoint(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				UnityEngine.AudioClip arg0 = ToLua.CheckObject<UnityEngine.AudioClip>(L, 1);
	...
	static int SetCustomCurve(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 3);
			UnityEngine.AudioSource obj = ToLua.CheckObject<UnityEngine.AudioSource>(L, 1);
			UnityEngine.AudioSourceCurveType arg0 = StackTraits<UnityEngine.AudioSourceCurveType>.Check(L, 2);
			UnityEngine.AnimationCurve arg1 = ToLua.CheckObject<UnityEngine.AnimationCurve>(L, 3);
	...
	static int GetSpectrumData(IntPtr L)
	{
		try
		{
			...
			float[] arg0 = ToLua.CheckNumberArray<float>(L, 2);
			int arg1 = (int)LuaDLL.luaL_checkinteger(L, 3);
			UnityEngine.FFTWindow arg2 = StackTraits<UnityEngine.FFTWindow>.Check(L, 4);
	...
	{
		UnityEngine.AudioSource obj = null;
		try
		{
			obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
	...
	static int get_gamepadSpeakerOutputType(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index gamepadSpeakerOutputType on a nil value");
		}
	}
	...
	static int set_outputAudioMixerGroup(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
			UnityEngine.Audio.AudioMixerGroup arg0 = ToLua.CheckObject<UnityEngine.Audio.AudioMixerGroup>(L, 2);
	...
	static int set_gamepadSpeakerOutputType(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
			UnityEngine.GamepadSpeakerOutputType arg0 = StackTraits<UnityEngine.GamepadSpeakerOutputType>.Check(L, 2);
	...
	static int set_velocityUpdateMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
			UnityEngine.AudioVelocityUpdateMode arg0 = StackTraits<UnityEngine.AudioVelocityUpdateMode>.Check(L, 2);
	...
	static int set_rolloffMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
			UnityEngine.AudioRolloffMode arg0 = StackTraits<UnityEngine.AudioRolloffMode>.Check(L, 2);
