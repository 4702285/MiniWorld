...
public class UnityEngine_ApplicationWrap
{
	...
	static int IsPlaying(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Object arg0 = ToLua.CheckObject<UnityEngine.Object>(L, 1);
	...
	static int GetStackTraceLogType(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.LogType arg0 = StackTraits<UnityEngine.LogType>.Check(L, 1);
	...
	static int SetStackTraceLogType(IntPtr L)
	{
		try
		{
			...
			UnityEngine.LogType arg0 = StackTraits<UnityEngine.LogType>.Check(L, 1);
			UnityEngine.StackTraceLogType arg1 = StackTraits<UnityEngine.StackTraceLogType>.Check(L, 2);
	...
	static int RequestUserAuthorization(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.UserAuthorization arg0 = StackTraits<UnityEngine.UserAuthorization>.Check(L, 1);
	...
	static int get_installMode(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Application.installMode);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_sandboxType(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Application.sandboxType);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_backgroundLoadingPriority(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Application.backgroundLoadingPriority);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_platform(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Application.platform);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_systemLanguage(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Application.systemLanguage);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_internetReachability(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Application.internetReachability);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_backgroundLoadingPriority(IntPtr L)
	{
		try
		{
			UnityEngine.ThreadPriority arg0 = StackTraits<UnityEngine.ThreadPriority>.Check(L, 2);
