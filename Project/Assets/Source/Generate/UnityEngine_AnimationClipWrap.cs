...
public class UnityEngine_AnimationClipWrap
{
	...
	static int SampleAnimation(IntPtr L)
	{
		try
		{
			...
			UnityEngine.AnimationClip obj = ToLua.CheckObject<UnityEngine.AnimationClip>(L, 1);
	...
	static int SetCurve(IntPtr L)
	{
		try
		{
			...
			UnityEngine.AnimationCurve arg3 = ToLua.CheckObject<UnityEngine.AnimationCurve>(L, 5);
	...
	static int AddEvent(IntPtr L)
	{
		try
		{
			...
			UnityEngine.AnimationClip obj = ToLua.CheckObject<UnityEngine.AnimationClip>(L, 1);
			UnityEngine.AnimationEvent arg0 = ToLua.CheckObject<UnityEngine.AnimationEvent>(L, 2);
			obj.AddEvent(arg0);
			return 0;
		}
		catch (Exception e)
	...
	{
		UnityEngine.AnimationClip obj = null;
		try
		{
			obj = (UnityEngine.AnimationClip)ToLua.ToObject(L, 1);
