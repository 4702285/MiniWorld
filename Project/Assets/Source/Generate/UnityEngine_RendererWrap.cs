...
public class UnityEngine_RendererWrap
{
	...
	static int HasPropertyBlock(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Renderer obj = ToLua.CheckObject<UnityEngine.Renderer>(L, 1);
	...
	static int SetPropertyBlock(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.Renderer obj = ToLua.CheckObject<UnityEngine.Renderer>(L, 1);
				UnityEngine.MaterialPropertyBlock arg0 = ToLua.CheckObject<UnityEngine.MaterialPropertyBlock>(L, 2);
	...
	{
		UnityEngine.Renderer obj = null;
		try
		{
			obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
	...
	static int get_forceRenderingOff(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index forceRenderingOff on a nil value");
		}
	}
	...
	static int get_rayTracingMode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, obj, "attempt to index rayTracingMode on a nil value");
		}
	}
	...
	static int set_shadowCastingMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
			UnityEngine.Rendering.ShadowCastingMode arg0 = StackTraits<UnityEngine.Rendering.ShadowCastingMode>.Check(L, 2);
	...
	static int set_motionVectorGenerationMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
			UnityEngine.MotionVectorGenerationMode arg0 = StackTraits<UnityEngine.MotionVectorGenerationMode>.Check(L, 2);
	...
	static int set_lightProbeUsage(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
			UnityEngine.Rendering.LightProbeUsage arg0 = StackTraits<UnityEngine.Rendering.LightProbeUsage>.Check(L, 2);
	...
	static int set_reflectionProbeUsage(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
			UnityEngine.Rendering.ReflectionProbeUsage arg0 = StackTraits<UnityEngine.Rendering.ReflectionProbeUsage>.Check(L, 2);
	...
	static int set_rayTracingMode(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
			UnityEngine.Experimental.Rendering.RayTracingMode arg0 = StackTraits<UnityEngine.Experimental.Rendering.RayTracingMode>.Check(L, 2);
	...
	static int set_lightProbeProxyVolumeOverride(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
			UnityEngine.GameObject arg0 = ToLua.CheckObject<UnityEngine.GameObject>(L, 2);
	...
	static int set_material(IntPtr L)
	{
		...
		{
			obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
			UnityEngine.Material arg0 = ToLua.CheckObject<UnityEngine.Material>(L, 2);
			obj.material = arg0;
			return 0;
		}
		catch(Exception e)
